                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body">
                              <div class="user-post-data">
                                 <div class="d-flex flex-wrap">
                                    <div class="media-support-user-img mr-3">
                                       <img class="rounded-circle img-fluid" src="{{asset('template/images/user/01.jpg')}}" alt="">
                                    </div>
                              ...
                              <div class="user-post">
                                 <div class="d-flex">
                                    <div class="col-md-6">
                                       <a href="javascript:void();"><img src="{{asset('template/images/page-img/p2.jpg')}}" alt="post-image" class="img-fluid rounded w-100"></a>
                                    </div>
                                    <div class="col-md-6 row m-0 p-0">
                                       <div class="col-sm-12">
                                          <a href="javascript:void();"><img src="{{asset('template/images/page-img/p1.jpg')}}" alt="post-image" class="img-fluid rounded w-100"></a>
                                       </div>
                                       <div class="col-sm-12 mt-3">
                                          <a href="javascript:void();"><img src="{{asset('template/images/page-img/p3.jpg')}}" alt="post-image" class="img-fluid rounded w-100"></a>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="comment-area mt-3">
                                    ...
                                    <div class="like-block position-relative d-flex align-items-center">
                                       <div class="d-flex align-items-center">
                                          <div class="like-data">
                                             <div class="dropdown">
                                                <span class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="button">
                                                <img src="{{asset('template/images/icon/01.png')}}" class="img-fluid" alt="">
                                                </span>
                                                <div class="dropdown-menu">
                                                   <a class="ml-2 mr-2" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Like"><img src="{{asset('template/images/icon/01.png')}}" class="img-fluid" alt=""></a>
                                                   <a class="mr-2" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Love"><img src="{{asset('template/images/icon/02.png')}}" class="img-fluid" alt=""></a>
                                                   <a class="mr-2" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Happy"><img src="{{asset('template/images/icon/03.png')}}" class="img-fluid" alt=""></a>
                                                   <a class="mr-2" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="HaHa"><img src="{{asset('template/images/icon/04.png')}}" class="img-fluid" alt=""></a>
                                                   <a class="mr-2" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Think"><img src="{{asset('template/images/icon/05.png')}}" class="img-fluid" alt=""></a>
                                                   <a class="mr-2" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Sade"><img src="{{asset('template/images/icon/06.png')}}" class="img-fluid" alt=""></a>
                                                   <a class="mr-2" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Lovely"><img src="{{asset('template/images/icon/07.png')}}" class="img-fluid" alt=""></a>
                                                </div>
                                             </div>
                                          </div>
                                 ...
                                 <ul class="post-comments p-0 m-0">
                                    ...
                                    <li>
                                       <div class="d-flex flex-wrap">
                                          <div class="user-img">
                                             <img src="{{asset('template/images/user/03.jpg')}}" alt="userimg" class="avatar-35 rounded-circle img-fluid">
                                          </div>
                                          <div class="comment-data-block ml-3">
                                             <h6>Paul Molive</h6>
                                             <p class="mb-0">Lorem ipsum dolor sit amet</p>
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body">
                              <div class="user-post-data">
                                 <div class="d-flex flex-wrap">
                                    <div class="media-support-user-img mr-3">
                                       <img class="rounded-circle img-fluid" src="{{asset('template/images/user/04.jpg')}}" alt="">
                                    </div>
                                    <div class="media-support-info mt-2">
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body">
                              <div class="post-item">
                                 <div class="d-flex flex-wrap">
                                    <div class="media-support-user-img mr-3">
                                       <img class="rounded-circle img-fluid" src="{{asset('template/images/user/1.jpg')}}" alt="">
                                    </div>
                                    <div class="media-support-info mt-2">
                              ...
                              <div class="user-post text-center">
                                 <a href="javascript:void();"><img src="{{asset('template/images/page-img/p5.jpg')}}" alt="post-image" class="img-fluid rounded w-100 mt-3"></a>
                              </div>
                              <div class="comment-area mt-3">
                                 <div class="d-flex justify-content-between align-items-center">
                                    <div class="like-block position-relative d-flex align-items-center">
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body">
                              <div class="user-post-data">
                                 <div class="d-flex flex-wrap">
                                    <div class="media-support-user-img mr-3">
                                       <img class="rounded-circle img-fluid" src="{{asset('template/images/user/02.jpg')}}" alt="">
                                    </div>
                                    <div class="media-support-info mt-2">
                        ...
                        <div class="iq-card-body">
                           <ul class="media-story m-0 p-0">
                              ...
                              <li class="d-flex mb-4 align-items-center active">
                                 <img src="{{asset('template/images/page-img/s2.jpg')}}" alt="story-img" class="rounded-circle img-fluid">
                                 <div class="stories-data ml-3">
                                    <h5>Anna Mull</h5>
                              ...
                              <li class="d-flex mb-4 align-items-center">
                                 <img src="{{asset('template/images/page-img/s3.jpg')}}" alt="story-img" class="rounded-circle img-fluid">
                                 <div class="stories-data ml-3">
                                    <h5>Ira Membrit</h5>
                              ...
                              <li class="d-flex align-items-center">
                                 <img src="{{asset('template/images/page-img/s1.jpg')}}" alt="story-img" class="rounded-circle img-fluid">
                                 <div class="stories-data ml-3">
                                    <h5>Bob Frapples</h5>
