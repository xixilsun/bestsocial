						...
						<div class="row">
							...
							<div class="iq-card">
								<div class="iq-card-body">
									@foreach(App\User::find($id)->posts->sortByDesc('post_id') as $post)
									<div class="post-item">
										...
										<div class="comment-area mt-3">
											...
											<ul class="post-comments p-0 m-0">
												@forelse(App\Post::find($post->post_id)->post_comments as $komen)
												<li class="mb-2">
													<div class="d-flex flex-wrap">
														<div class="user-img">
											...
											<form class="comment-text d-flex align-items-center mt-3" role="form" action="/comment/storeProfile" method="POST">
											@csrf
												<input type="text" class="form-control rounded" name="comment">
												<input type="text" class="form-control rounded" name="post_id"  value="{{$post->post_id}}" hidden>
