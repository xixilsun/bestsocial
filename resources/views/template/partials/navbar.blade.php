                        ...
                        <div class="iq-card-body p-0 ">
                           ...
                           <div class="iq-friend-request">
                              <div class="iq-sub-card iq-sub-card-big d-flex align-items-center justify-content-between" >
                                 <div class="d-flex align-items-center">
                                    <div class="">
                                       <img class="avatar-40 rounded" src="{{asset('template/images/user/01.jpg')}}" alt="">
                                    </div>
                           ...
                           <div class="iq-friend-request">
                              <div class="iq-sub-card iq-sub-card-big d-flex align-items-center justify-content-between" >
                                 <div class="d-flex align-items-center">
                                    <div class="">
                                       <img class="avatar-40 rounded" src="{{asset('template/images/user/02.jpg')}}" alt="">
                                    </div>
                                    <div class="media-body ml-3">
                           ...
                           <div class="iq-friend-request">
                              <div class="iq-sub-card iq-sub-card-big d-flex align-items-center justify-content-between" >
                                 <div class="d-flex align-items-center">
                                    <div class="">
                                       <img class="avatar-40 rounded" src="{{asset('template/images/user/03.jpg')}}" alt="">
                                    </div>
                                    <div class="media-body ml-3">
                           ...
                           <div class="iq-friend-request">
                              <div class="iq-sub-card iq-sub-card-big d-flex align-items-center justify-content-between" >
                                 <div class="d-flex align-items-center">
                                    <div class="">
                                       <img class="avatar-40 rounded" src="{{asset('template/images/user/04.jpg')}}" alt="">
                                    </div>
                                    <div class="media-body ml-3">
                     ...
                     <div class="iq-card shadow-none m-0">
                        <div class="iq-card-body p-0 ">
                           ...
                           <a href="#" class="iq-sub-card" >
                              <div class="media align-items-center">
                                 <div class="">
                                    <img class="avatar-40 rounded" src="{{asset('template/images/user/05.jpg')}}" alt="">
                                 </div>
                                 <div class="media-body ml-3">
